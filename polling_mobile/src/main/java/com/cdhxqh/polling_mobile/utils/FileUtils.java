...
public class FileUtils {
     ...
     * </FORM>
     *
     * @param urlpath   上传路径(注：避免使用localhost或127.0.0.1这样的路径测试，因为它会指向手机模拟器，你可以使用http://www.iteye.cn或http://192.168.1.101:8083这样的路径测试)
     */

    public static boolean filePost(String urlpath, File file){
